...
public class C4 
    ...
    */
    ...
    public int minimax2 (int profundidad, Tauler t, int color, int True_Color, int col, int alpha, int beta){
        ...
        if(color == True_Color){
            for(int i = 0; i < t.getMida() && t.movpossible(i); ++i){
                alpha = Math.max(alpha, minimax2(profundidad- 1, asme, color, True_Color, i, alpha, beta));
                if(alpha >= beta){
                    return beta;
                }
            }
            ...
            for(int i = 0; i < t.getMida() && t.movpossible(i); ++i){
                beta = Math.min(beta, minimax2(profundidad- 1, asme, color, True_Color, i, alpha, beta));
                if(alpha >= beta){
                    return alpha;
                }
            }
...
//        return heuristica;
   ...
   public int choosemove(Tauler t, int color, int profundidad){
    ...
    for(int i = 0; i < t.getMida() && t.movpossible(i); ++i)
    {
        alpha = Math.max(alpha, minimax2(profundidad - 1, t, color, True_Color, i, alpha, beta));
        x+="."+alpha;
        if(alpha > bestScore)
        {
            col = i;
